...
(function() {
    ...
    services.service("yuidocDataService", function($resource, querifySync, yuidocDataPath) {
        ...
        YuidocDataService.prototype = {
            ...
            get dataset() {
                if (this.dataset_ === null) throw Error("YuidocDataService: dataset is not loaded.");
...
(function() {
        ...
        return {
            ...
            link: function($scope) {
                ...
                if (classItem.example) {
                    for (var index = 0; index < classItem.example.length; index++) classItem.example[index] = $sce.trustAsHtml(marked(classItem.example[index]));
                }
            }
        };
    });
    ...
    module.directive("classItemMethod", function($sce, marked) {
        return {
            ...
            link: function($scope) {
                if ($scope.classItem.return && $scope.classItem.return.description) $scope.classItem.return.description = $sce.trustAsHtml(marked($scope.classItem.return.description));
            }
        };
    });
